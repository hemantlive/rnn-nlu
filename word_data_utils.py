...
def prepare_multi_task_data(data_dir, in_vocab_size, out_vocab_size):
    ...
    create_vocabulary(in_vocab_path, data_dir + "/twitter.raw", in_vocab_size, tokenizer=naive_tokenizer)
    ...
    data_to_token_ids(train_path + ".raw", in_seq_train_ids_path, in_vocab_path, tokenizer=naive_tokenizer)
    ...
    data_to_token_ids(dev_path + ".raw", in_seq_dev_ids_path, in_vocab_path, tokenizer=naive_tokenizer)
    ...
    data_to_token_ids(test_path + ".raw", in_seq_test_ids_path, in_vocab_path, tokenizer=naive_tokenizer)
